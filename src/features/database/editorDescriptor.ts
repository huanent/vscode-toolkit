...
export const editorViewType = 'vscode-toolkit.database.editor';

export type EditorKind = 'serverForm' | 'mysqlEditor' | 'mysqlTablePreview';
...
export function parseEditorDescriptor(uri: vscode.Uri): EditorDescriptor {
	...
	return {
		...
		serverType: serverType === 'mysql' ? serverType : undefined,
...
function isEditorKind(value: string | null): value is EditorKind {
	return value === 'serverForm' || value === 'mysqlEditor' || value === 'mysqlTablePreview';
}
