...
export const editorViewType = 'vscode-toolkit.ssh.editor';

export type EditorKind = 'serverForm' | 'sshTerminal';
...
export function parseEditorDescriptor(uri: vscode.Uri): EditorDescriptor {
	...
	return {
		...
		serverType: serverType === 'ssh' ? serverType : undefined,
...
function isEditorKind(value: string | null): value is EditorKind {
	return value === 'serverForm' || value === 'sshTerminal';
}
