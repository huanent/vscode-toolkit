...
export function Toolbar({ state, actions }: ToolbarProps) {
	...
	return (
		<header className="grid shrink-0 grid-cols-[auto_minmax(0,1fr)_32px] items-center gap-2 border-b border-(--vscode-panel-border) bg-(--vscode-editor-background) p-2 text-sm">
			...
			<div className="relative grid min-h-8 min-w-0 grid-cols-[minmax(0,1fr)_auto] items-center">
				{state.searchOpen ? (
					<Input
