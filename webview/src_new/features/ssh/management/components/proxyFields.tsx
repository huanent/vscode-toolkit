...
import { PasswordInput, Textarea, Input } from '../../../../components/ui/input';
import { Segmented } from '../../../../components/ui/segmented';
import type { ConnectionFormState } from '../hooks/useConnectionForm';

export function ProxyFields({ form }: { form: ConnectionFormState }) {
	const { values } = form;
	...
	>(
		key: Key,
		value: ConnectionFormState['values'][Key],
	) => {
